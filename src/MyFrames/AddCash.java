...
public class AddCash extends javax.swing.JInternalFrame {
    ...
    private void updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateActionPerformed
        String query = "UPDATE `cash` SET `name`='" + jTextField2.getText() + "',`id`=" + jTextField1.getText() + ",`mno`='" + jTextField3.getText() + "',`address`='" + jTextField4.getText() + "',`email`='" + jTextField5.getText() + "',`password`='" + jTextField6.getText() + "' WHERE `id`=" + jTextField1.getText();
