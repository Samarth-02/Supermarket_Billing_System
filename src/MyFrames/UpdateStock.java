...
public class UpdateStock extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jButton3.setMaximumSize(new java.awt.Dimension(111, 33));
        jButton3.setMinimumSize(new java.awt.Dimension(111, 33));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String query = "DELETE FROM `stock` WHERE `id`=" + jTextField1.getText();
