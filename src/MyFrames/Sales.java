...
public class Sales extends javax.swing.JInternalFrame {
    ...
    public ArrayList<BillSearch> List(String ValToSearch) {
        ...
        try {
            ...
            String query = "SELECT * FROM `bill` WHERE `pdate`='" + jTextField1.getText() + "';";
    ...
    public void findbill() {
        ...
        model.setColumnIdentifiers(new Object[]{"Bill No", "Customer Name", "Total Amount", "Date"});
